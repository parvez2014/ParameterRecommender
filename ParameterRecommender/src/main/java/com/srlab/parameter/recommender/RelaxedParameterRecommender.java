...
public class RelaxedParameterRecommender {
	...
	public RelaxedParameterRecommender() {
	...
	public void testInstance(ParameterModelEntry query, MethodCallExpr methodCallExpr, 
				...
				query.getParameterPosition())) 
		{
			...
			System.out.println("******************Query: "+ query.getParameterContent().getRawStringRep()+"  AbsSTringRepWIthLiteral: "+query.getParameterContent().getAbsStringRep()+"  AbsStringRep: "+query.getParameterContent().getAbsStringRep());
			...
			for(int i=0;i<possibleCandidateList.size();i++){
				...
				if(i<5) {
					System.out.println("possible Candidate ["+i+"] AbsStringRep: "+candidate.getParameterContent().getAbsStringRep()+"  AbsStringLiteral:" +candidate.getParameterContent().getAbsStringRepWithLiteral());
				}
				
				rank++;
				if(hmVisitedRecommendations.contains(candidate.getParameterContent().getAbsStringRepWithLiteral())) {
					rank--; continue;
				}
				if(hmVisitedRecommendations.contains(candidate.getParameterContent().getAbsStringRepWithLiteral())==false &&
						candidate.getParameterContent() instanceof StringLiteralContent 
						&& query.getParameterContent() instanceof StringLiteralContent 
						&& candidate.getParameterContent().getAbsStringRepWithLiteral().equals(query.getParameterContent().getAbsStringRepWithLiteral())){
					found=true;
					System.out.println("Rank: "+rank);
					break;
				}
				else if(hmVisitedRecommendations.contains(candidate.getParameterContent().getAbsStringRepWithLiteral())==false &&
					...
					break;
						...
						&& candidate.getParameterContent().getAbsStringRepWithLiteral().equals(query.getParameterContent().getAbsStringRepWithLiteral().trim())){
					found=true;
					break;
				}
				else if(hmVisitedRecommendations.contains(candidate.getParameterContent().getAbsStringRepWithLiteral())==false &&
						candidate.getParameterContent() instanceof NameExprContent && query.getParameterContent() instanceof NameExprContent
						&& candidate.getParameterContent().getAbsStringRepWithLiteral().equals(query.getParameterContent().getAbsStringRepWithLiteral()))
						 {
					...
					break;
						...
						&& candidate.getParameterContent().getAbsStringRepWithLiteral().equals(query.getParameterContent().getAbsStringRepWithLiteral().trim())) {
					System.out.println("Query Abs String: "+query.getParameterContent().getAbsStringRepWithLiteral());
					System.out.println("Candidate: "+candidate.getParameterContent().getAbsStringRepWithLiteral());
				...
				hmVisitedRecommendations.add(candidate.getParameterContent().getAbsStringRepWithLiteral());
			}
			if(found==true) {
	...
	public static void main(String[] args) {
		...
		RelaxedParameterRecommender relaxedParameterRecommender = new RelaxedParameterRecommender();
		relaxedParameterRecommender.train(trainingTestGenerator.getTrainingParameterModelEntryList());
		relaxedParameterRecommender.test(trainingTestGenerator.getTestParameterModelEntryList());
	}
}
